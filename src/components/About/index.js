    ...
    <div className="aboutMe">
      ...
      <div className="main">
        ...
        <p>
          ...
          <br></br>
          03.2016 - 07.2022 Jade Hochschule University in Wilhelmshaven, Germany
          <br></br>
          Focus: energy and environmental technology<br></br>
          Final thesis: Efficiency of solar and wind energy using the example of
          energy production in Colorado (USA) - comparison and potential
          analysis
        </p>
